...
export class CheckoutPage extends BasePage {
  ...
  private readonly continueShopping = this.page.locator('[data-test="continue"]');
  private readonly checkoutButton = this.page.locator('[data-test="checkout"]');
  private readonly summaryLabel = this.page.locator('[data-test="total-info-label"]')

  constructor(page:Page){
    super(page);
  }

  async fillShippingInfo(expetcedFName:string,expectedLName:string,expectedZip:string){
